...
export const remoteService11 = {
  '/api/batch/del_batch':{post: (reqData:  DelBatchBO) => _httplib<boolean>( {url:'/api/batch/del_batch',method:'post','params':reqData}, {originUrl:'/api/batch/del_batch',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/export_task':{post: (reqData:  ExportTaskBO) => _httplib<string>( {url:'/api/batch/export_task',method:'post','params':reqData}, {originUrl:'/api/batch/export_task',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/publish_member':{post: (reqData:  PublishMemberBO) => _httplib<PublishMemberVO>( {url:'/api/batch/publish_member',method:'post','params':reqData}, {originUrl:'/api/batch/publish_member',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_batch':{post: (reqData:  BatchBO) => _httplib<BatchVO>( {url:'/api/batch/query_batch',method:'post','params':reqData}, {originUrl:'/api/batch/query_batch',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_batch_detail':{post: (reqData:  BatchDetailBO) => _httplib<BatchDetailVO>( {url:'/api/batch/query_batch_detail',method:'post','params':reqData}, {originUrl:'/api/batch/query_batch_detail',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_batch_list':{post: (reqData:  QueryBatchBO) => _httplib<PageableData_BatchVO_>( {url:'/api/batch/query_batch_list',method:'post','params':reqData}, {originUrl:'/api/batch/query_batch_list',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_batch_mgnt':{post: (reqData:  QueryBatchMgntBO) => _httplib<BatchNameVO[]>( {url:'/api/batch/query_batch_mgnt',method:'post','params':reqData}, {originUrl:'/api/batch/query_batch_mgnt',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_list':{post: (reqData:  QueryMemberBO) => _httplib<BatchPageVO>( {url:'/api/batch/query_list',method:'post','params':reqData}, {originUrl:'/api/batch/query_list',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/query_lottery':{post: (reqData:  number) => _httplib<LotteryVO>( {url:'/api/batch/query_lottery',method:'post','params':reqData}, {originUrl:'/api/batch/query_lottery',paramNamesInPath:[],paramNamesInQuery:["batchId"],paramLen:1}) },
  '/api/batch/query_phase': { get: () => _httplib<PhaseVO[]>( {url:'/api/batch/query_phase',method:'get','params':undefined}, {originUrl:'/api/batch/query_phase',paramNamesInPath:[],paramNamesInQuery:[],paramLen:0}) },
  '/api/batch/query_school_mgnt':{post: (reqData:  QuerySchoolMgntBO) => _httplib<SchoolNameVO[]>( {url:'/api/batch/query_school_mgnt',method:'post','params':reqData}, {originUrl:'/api/batch/query_school_mgnt',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/save_or_update':{post: (reqData:  SaveOrUpdateBatchBO) => _httplib<BatchVO>( {url:'/api/batch/save_or_update',method:'post','params':reqData}, {originUrl:'/api/batch/save_or_update',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/start_lottery':{post: (reqData:  StartLotteryBO) => _httplib<boolean>( {url:'/api/batch/start_lottery',method:'post','params':reqData}, {originUrl:'/api/batch/start_lottery',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/batch/task_result':{get: (reqData:  string) => _httplib<ExportVO>( {url:'/api/batch/task_result',method:'get','params':reqData}, {originUrl:'/api/batch/task_result',paramNamesInPath:[],paramNamesInQuery:["taskId"],paramLen:1}) },
  '/api/batch/valid_file':{post: (reqData:  ValidFileBO) => _httplib<ValidInfoVO>( {url:'/api/batch/valid_file',method:'post','params':reqData}, {originUrl:'/api/batch/valid_file',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
  '/api/templete/down_template':{post: (reqData:  DownTemplateBO) => _httplib<string>( {url:'/api/templete/down_template',method:'post','params':reqData}, {originUrl:'/api/templete/down_template',paramNamesInPath:[],paramNamesInQuery:[],paramLen:1}) },
